...
export class Initial1619116568001 implements MigrationInterface {
    name = 'Initial1619116568001'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "upvote" ("value" boolean NOT NULL, "userId" integer NOT NULL, "postId" integer NOT NULL, CONSTRAINT "PK_802ac6b9099f86aa24eb22d9c05" PRIMARY KEY ("userId", "postId"))`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_9e91e6a24261b66f53971d3f96" ON "post" ("creatorId") `);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "IDX_fb91bea2d37140a877b775e6b2"`);
        await queryRunner.query(`DROP INDEX "IDX_9e91e6a24261b66f53971d3f96"`);
